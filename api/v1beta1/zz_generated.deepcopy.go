...
func (in *SourceServiceAccount) DeepCopyInto(out *SourceServiceAccount) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SourceServiceAccount.
func (in *SourceServiceAccount) DeepCopy() *SourceServiceAccount {
	if in == nil {
		return nil
	}
	out := new(SourceServiceAccount)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TargetServiceAccount.
...
func (in *TokenSpec) DeepCopyInto(out *TokenSpec) {
	*out = *in
	out.SourceServiceAccount = in.SourceServiceAccount
	out.TargetServiceAccount = in.TargetServiceAccount
}
